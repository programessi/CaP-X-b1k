...
OUTPUT_DIR="${OUTPUT_DIR:-./outputs/oracle/x2_pick_place_two_objects_blue_right_rgbd_visual}"
VISUAL_ARTIFACT_DIR="${VISUAL_ARTIFACT_DIR:-${REPO_ROOT}/outputs/x2_visual_artifacts/two_objects_blue_right_rgbd_visual_oracle}"
